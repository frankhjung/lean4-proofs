...
/-!
  **Problem 5**
  ...
  A toy mouse changes speed from 2 m/s to 0 m/s in the span of 2 seconds.
  It's mass is estimated to be around 0.1 kg.
  The toy can only handle 2 Netwons of force (otherwise it breaks).
  Prove that the force it experiences in stopping is below that limit.
-/
